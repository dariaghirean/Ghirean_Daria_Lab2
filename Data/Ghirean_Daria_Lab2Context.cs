...
namespace Ghirean_Daria_Lab2.Data
{
    public class Ghirean_Daria_Lab2Context : DbContext
    {
        ...
        public DbSet<Ghirean_Daria_Lab2.Models.Category> Category { get; set; } = default!;
        public DbSet<Ghirean_Daria_Lab2.Models.Member> Member { get; set; } = default!;
        public DbSet<Ghirean_Daria_Lab2.Models.Borrowing> Borrowing { get; set; } = default!;
    }
}
