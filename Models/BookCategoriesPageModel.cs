...
namespace Ghirean_Daria_Lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        ...
        public void PopulateAssignedCategoryData(Ghirean_Daria_Lab2Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Ghirean_Daria_Lab2Context context, string[] selectedCategories, Book bookToUpdate)
        {
